                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="post" action="{{ route('admin.portfolio.update', $portfolio) }}" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="mt-2 mb-2">
                                <img src="{{ Storage::url($portfolio->image) }}" class="h-32 object-cover rounded">
                            </div>
                        ...
                        <!-- KML File -->
                        <div>
                            <x-input-label for="kml_file" :value="__('KML File (Map Data - Leave blank to keep current)')" />
                            @if($portfolio->kml_file)
                                <div class="mt-2 mb-2 text-sm text-gray-600">
                                    Current file: {{ basename($portfolio->kml_file) }}
                                </div>
                            @endif
