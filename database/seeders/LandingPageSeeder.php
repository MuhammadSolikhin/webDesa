...
class LandingPageSeeder extends Seeder
{
    ...
    {
        \App\Models\Hero::insert([
            [
                'title' => 'We are professional',
                'description' => 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.',
                'image' => 'landingPage/img/hero-carousel/hero-carousel-1.jpg',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'image' => 'landingPage/img/hero-carousel/hero-carousel-2.jpg',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'image' => 'landingPage/img/hero-carousel/hero-carousel-3.jpg',
                'created_at' => now(),
                'updated_at' => now(),
            ],
        ]);
        ...
        $settings = [
            'about_title' => 'Consequatur eius et magnam',
            'about_subtitle' => 'Our Story',
            'about_description' => 'Inventore aliquam beatae at et id alias. Ipsa dolores amet consequuntur minima quia maxime autem. Quidem id sed ratione. Tenetur provident autem in reiciendis rerum at dolor. Aliquam consectetur laudantium temporibus dicta minus dolor.',
            'about_points' => json_encode([
                'Ullamco laboris nisi ut aliquip ex ea commo',
                'Duis aute irure dolor in reprehenderit in',
                'Ullamco laboris nisi ut aliquip ex ea'
            ]),
            'about_summary' => 'Vitae autem velit excepturi fugit. Animi ad non. Eligendi et non nesciunt suscipit repellendus porro in quo eveniet. Molestias in maxime doloremque.',
            'about_video_url' => 'https://www.youtube.com/watch?v=Y7f98aduVJ8',
            'about_image' => 'landingPage/img/about.jpg',
        ...
        foreach ($settings as $key => $value) {
            \App\Models\LandingSetting::create([
                'key' => $key,
                'value' => $value,
            ]);
        }
