        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-xl">
                <div class="p-8 text-gray-900">
                    <h4 class="text-lg font-semibold mb-4 text-gray-800">Semua Transaksi Anda</h4>
                    ...
                    @else
                        <div class="bg-gray-50 border border-gray-200 border-dashed rounded-xl p-10 text-center">
                            ...
                            <p class="text-gray-500 mb-6">Anda belum pernah memesan paket wisata apapun.</p>
