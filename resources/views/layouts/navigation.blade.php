<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('admin.landing.edit')" :active="request()->routeIs('admin.landing.edit')">
                        {{ __('Manage Landing Page') }}
                    </x-nav-link>
                    <x-nav-link :href="route('admin.menu.index')" :active="request()->routeIs('admin.menu.*')">
                        {{ __('Manage Menus') }}
                    </x-nav-link>
                    <x-nav-link :href="route('admin.service.index')" :active="request()->routeIs('admin.service.*')">
                        {{ __('Kelola Layanan') }}
                    </x-nav-link>
                    <x-nav-link :href="route('admin.portfolio.index')" :active="request()->routeIs('admin.portfolio.*')">
                        {{ __('Kelola Objek Wisata') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('admin.landing.edit')" :active="request()->routeIs('admin.landing.edit')">
                {{ __('Manage Landing Page') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('admin.menu.index')" :active="request()->routeIs('admin.menu.*')">
                {{ __('Manage Menus') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('admin.service.index')" :active="request()->routeIs('admin.service.*')">
                {{ __('Kelola Layanan') }}
            </x-responsive-nav-link>
